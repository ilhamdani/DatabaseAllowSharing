...
public class SqlLiteManger {
    ...
    public void insert(String name, String version) {
        ...
        try {
            ...
            contentValues.put(SqlLiteDbHelper.VERSION_NAME, name);
            contentValues.put(SqlLiteDbHelper.VERSION_NO, version);
            database.insert(SqlLiteDbHelper.TABLE_NAME, null, contentValues);
